...
`,[a(">",[s("clear",`
 ...
 `,[f({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),x=n({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(r){return u("-base-clear",v,h(r,"clsPrefix")),{handleMouseDown(o){o.preventDefault()}}},render(){const{clsPrefix:r}=this;return e("div",{class:`${r}-base-clear`},e(C,null,{default:()=>{var o,l;return this.show?e("div",{key:"dismiss",class:`${r}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},i(this.$slots.icon,()=>[e(t,{clsPrefix:r},{default:()=>e(L,null)})])):e("div",{key:"icon",class:`${r}-base-clear__placeholder`},(l=(o=this.$slots).placeholder)===null||l===void 0?void 0:l.call(o))}}))}}),B=n({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(r,{slots:o}){return()=>{const{clsPrefix:l}=r;return e(w,{clsPrefix:l,class:`${l}-base-suffix`,strokeWidth:24,scale:.85,show:r.loading},{default:()=>r.showArrow?e(x,{clsPrefix:l,show:r.showClear,onClear:r.onClear},{placeholder:()=>e(t,{clsPrefix:l,class:`${l}-base-suffix__arrow`},{default:()=>i(o.default,()=>[e(p,null)])})}):null})}}});export{p as C,B as N,x as a};
