...
export default {
  ...
  synchronization_definition: {
    ...
    scene_mode_first: 'Please select scene mode first',
    datasource_tips: 'Please select a datasource',
    datasource_empty_hint:
      'No datasource available. Select Single Table Sync scene mode and ensure the matching SeaTunnel connector plugin (e.g. connector-jdbc) is installed, then sync connectors.',
    ...
    schedule_name_tips: 'Please enter schedule name',
    schedule_name_validate: 'Schedule name is required',
    crontab: 'Cron Expression',
    cron_mechanism: 'Timing Mechanism',
    crontab_tips: 'e.g. 0 0 2 * * ? runs daily at 2:00 AM',
    crontab_validate: 'Cron expression is required',
    schedule_type: 'Schedule Type',
    schedule_type_internal: 'Internal Scheduler',
    schedule_type_dolphin: 'DolphinScheduler',
    ...
    crontab_internal_hint:
      'Internal scheduler uses Spring Cron (6 fields with seconds), e.g. 0 0 2 * * ?',
    crontab_dolphin_hint:
      'DolphinScheduler uses Quartz Cron (7 fields). Configure DS connection in application.yml first',
    cron_field_second: 'Second',
    cron_field_minute: 'Minute',
    cron_field_hour: 'Hour',
    cron_field_day: 'Day',
    cron_field_month: 'Month',
    cron_field_week: 'Week',
    cron_mode_every: 'Every {field}',
    cron_mode_unspecified: 'Unspecified',
    cron_mode_period: 'Period from',
    cron_mode_loop: 'Loop from',
    cron_mode_appoint: 'Specify',
    cron_to: 'to',
    cron_loop_from: ', every',
    cron_loop_step: 'time(s)',
    cron_desc_every: 'Every {field}',
    cron_desc_period: '{field} from {start} to {end}',
    cron_desc_loop: '{field} starts at {start}, every {step}',
    cron_desc_appoint: '{field} set to {values}',
    cron_desc_default: 'Custom cron expression',
    cron_preview_title: 'Next 5 execution times',
    cron_preview_empty: 'No execution times to preview',
    cron_preview_failed: 'Invalid cron expression, unable to preview',
    cron_week_1: 'Sun',
    cron_week_2: 'Mon',
    cron_week_3: 'Tue',
    cron_week_4: 'Wed',
