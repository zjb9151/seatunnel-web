...
import org.apache.seatunnel.app.thirdparty.scheduler.DolphinSchedulerClient;
import org.apache.seatunnel.app.thirdparty.scheduler.DolphinSchedulerClient.DsSyncResult;
...
public class JobScheduleServiceImpl implements IJobScheduleService {
    ...
    public JobScheduleRes saveOrUpdate(Long jobDefineId, JobScheduleReq req) {
        ...
        JobSchedule schedule =
                existing != null
                        ...
                        : JobSchedule.builder()
                                ...
                                .createUserId(ServletUtils.getCurrentUserId())
                                .createTime(new Date())
                                .build();
        ...
        schedule.setUpdateUserId(ServletUtils.getCurrentUserId());
